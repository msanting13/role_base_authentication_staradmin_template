...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    <div class="container-scroller">
        ...
        @include('super-admin.layouts.partials.super-admin-navbar')
        <!-- partial -->

        <div class="container-fluid page-body-wrapper">
            <!-- partial:admin.layouts.partials.admin-sidebar -->
            @include('super-admin.layouts.partials.super-admin-sidebar')
            <!-- partial -->
            ...
            <div class="main-panel">
                ...
                @include('super-admin.layouts.partials.super-admin-footer')
            </div>
            <!-- main-panel ends -->
        </div>
